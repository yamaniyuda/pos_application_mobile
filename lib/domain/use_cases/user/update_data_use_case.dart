...
class UpdateDataUseCase extends UseCase<UserRepository, UserPaylaod> {
  UpdateDataUseCase() : super(UserRepositoryImpl());

  @override
  Future<UserEntity> call([UserPaylaod? params]) async {
    final UserEntity data = await repository.updateData(params!);
    return data;
  }
}
