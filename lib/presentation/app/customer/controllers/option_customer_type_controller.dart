...
class OptionCustomerTypeController extends GetxController {
  /// Inject depedency for fetch data customer type
  final FetchDataUseCase fetchDataUseCaseCustomerType = Get.find<FetchDataUseCase>(tag: 'customerType');

  /// List data customer type
  final RxList<CustomerTypeEntity> _customerTypeDatas = <CustomerTypeEntity>[].obs;
  List<CustomerTypeEntity> get customerTypeDatas => _customerTypeDatas.value;
  ...
  ///
  Future<void> fetchDataCustomerType({Map<String, dynamic>? queryParameters}) async {
