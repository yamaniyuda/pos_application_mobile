...
import 'package:pos_application_mobile/presentation/app/product/controllers/select_option_cloth_type_controller.dart';
import 'package:pos_application_mobile/presentation/widgets/pam_bottom/pam_bottom.dart';

class SelectOptionClothTypeScreen extends StatelessWidget {
  final controller = Get.put(SelectOptionClothTypeController());
  SelectOptionClothTypeScreen({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("${"choosee".tr} ${"product type".tr}".toCapitalize()),
      ),
      body: SafeArea(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                "${"choosee".tr} ${"product".tr}".toCapitalize()
              ),
              Expanded(
              ...
              PAMBottom(
                title: "${"choosee".tr} ${"product".tr}".toCapitalize(),
                isLoading: false,
