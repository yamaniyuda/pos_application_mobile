...
import 'package:pos_application_mobile/presentation/app/customer/controllers/search_provincy_controller.dart';
...
class SearchProvincyScreen extends StatelessWidget {
  final controller = Get.put(SearchProvincyController());
  SearchProvincyScreen({super.key});
  ...
  Widget _buildListCustomer() {
    return Obx(() {
      if (controller.isLoading && controller.dataProvincy.isEmpty) {
      ...
      return Expanded(
        child: PAMListScroll(
          ...
          itemCount: controller.dataProvincy.length,
          ...
          itemBuilder: (context, index) {
            return InkWell(
              onTap: () => controller.changeRadioSelection(
                controller.dataProvincy[index].id!,
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  border: Border(
                    bottom: BorderSide(
                      color: index != (controller.dataProvincy.length - 1)
                          ? Colors.black54
                          : Colors.transparent
                    )
                  )
