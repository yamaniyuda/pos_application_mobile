    ...
    return Obx(() {
      ...
      return Expanded(
        child: PAMListScroll(
          ...
          onRefresh: controller.fetchDataColor, 
          itemCount: controller.dataColors.length,
          scrollToRefresh: controller.totalPage == controller.currentPage ? false : true,
                  ...
                  endActionPane: ActionPane(
                    ...
                    children: [
                      ...
                      SlidableAction(
                        onPressed: (context) {
                          Get.to( 
                            ColorFormScreen(type: ColorFormScreenType.update), 
