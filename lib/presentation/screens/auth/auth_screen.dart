...
import 'package:pos_application_mobile/presentation/widgets/pam_alert/pam_alert_widget.dart';
        ...
        PAMBottom(
          ...
          onTab: () {
            if (_formKey.currentState!.validate()) {
              ...
              PAMAlertWidget.showLoadingAlert(context);
              controller.signIn(SignInPayload(
